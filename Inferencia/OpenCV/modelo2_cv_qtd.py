# Carrega bibliotecas necessárias (Adicionar bibliotecas da TPU?)
...
interpreter = tflite.Interpreter(model_path='modelo2_qtd.tflite')
...
cv2.imwrite('resultado_qtd.png', img)
